...
setwd("L:/Takeaki/Google drive/Past classes/Rochester Simon/2025 Spring A pricing analytics/Topic 4")
...
#WTP = ratio between beta0 and beta1
WTPKB2=(coef.est[,2])/(-coef.est[,5])
WTPKR2=(coef.est[,3])/(-coef.est[,5])

#Simulate a set of consumers to plot
fraction=100*round(seg.share,10)
WTPKB2sample=rep(WTPKB2,fraction)
WTPKR2sample=rep(WTPKR2,fraction)

#Histogram
h=hist(as.matrix(WTPKB2sample),
...
profitseg=profit1[pricespace==1.2]+profit2[pricespace==1.3]+profit3[pricespace==1.3]+
...
#Illustrative examples of clustering
aux1=rnorm(100,2.5,0.16)
aux2=rnorm(100,1.5,0.16)
aux3=rnorm(100,2.5,0.16)
aux4=rnorm(100,1.6,0.16)
aux5=rnorm(100,2.3,0.16)

plot(aux1,aux3,xlab="Demographic 1",ylab="Demographic 2",xlim=c(1,3.1),ylim=c(1,3.1),cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5)
points(aux1,aux4)
points(aux4,aux3)
points(aux2,aux4)

plot(aux1,aux3,xlab="Demographic 1",ylab="Demographic 2",xlim=c(1,3.1),ylim=c(1,3.1),col="red",cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5)
points(aux1,aux4,col="green")
points(aux4,aux3,col="blue")
points(aux2,aux4,col="orange")

set.seed(2)
aux1=rnorm(500,2,0.3)
aux2=rnorm(500,2,0.3)
aux=cbind(aux1+aux2,aux1,aux2)
aux=aux[order(aux[,1]),]

plot(aux[,2],aux[,3],xlab="Demographic 1",ylab="Demographic 2",col = rgb(0.1,0.1,0.1),xlim=c(1,3.1),ylim=c(1,3.1),cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5)


plot(aux[1:100,2],aux[1:100,3],xlab="Demographic 1",ylab="Demographic 2",col = rgb(0.7,0.5,0.3),xlim=c(1,3.1),ylim=c(1,3.1),cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5)
points(aux[101:200,2],aux[101:200,3],col = rgb(0.6,0.5,0.4))
points(aux[201:300,2],aux[201:300,3],col = rgb(0.5,0.5,0.5))
points(aux[301:400,2],aux[301:400,3],col = rgb(0.4,0.5,0.6))
points(aux[401:500,2],aux[401:500,3],col = rgb(0.3,0.5,0.7))
...
# maxother=rowMaxs(as.matrix(cbind(beta0mat[,2]+para[4]*mean(data$price.KR),beta0mat[,3]+para[4]*mean(data$price.MB),matrix(0L,nrow(beta0mat),1))),value=TRUE)
