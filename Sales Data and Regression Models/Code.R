...
setwd("L:/Takeaki/Google drive/Past classes/Rochester Simon/2025 Spring A pricing analytics/Topic 1")
...
summer=dummy_cols(simdata$month)[,3]
...
reg2=lm(log(sales)~log(price)+summer,data=simdata)
...
plot(simdata$price,simdata$sales, col=rep(1:2,each=8),pch=19, main="Price vs Sales",
     xlab="Price", ylab="Sales", cex=2,cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5)
legend("bottomright", legend = c("Other Periods", "Summer"), col = 1:2, pch = 19, bty = "n",cex=1.5)


plot(simdata$price,simdata$sales, pch=19, main="Price vs Sales",
     xlab="Price", ylab="Sales", cex=2,cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5)
legend("bottomright", legend = c("All Pooled Together"),  pch = 19, bty = "n",cex=1.5)
lines(pricespace,fitted,col="blue",lwd=2)
...
logpaug=log(simdata$price)*summer
reg3=lm(log(sales)~log(price)+summer+logpaug,data=simdata)
